...
const Footer = () => {
  return (
    <footer className="bg-german-primary text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex items-center space-x-4">
              <a href="#" className="text-white hover:text-german-secondary">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/visa-info" className="text-gray-300 hover:text-white">Visa Information</Link>
              </li>
              <li>
                <Link to="/relocation" className="text-gray-300 hover:text-white">Relocation Guide</Link>
              </li>
              <li>
                <Link to="/german-language" className="text-gray-300 hover:text-white">German Language Resources</Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-white">Career Blog</Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span>+4915214636946</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2" />
                <span>ugandajobsgermany@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
